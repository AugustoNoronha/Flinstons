...
function get() {
 var url = "http://localhost:4200/getitem";//Sua URL
  ...
  data.forEach((element) => {
    ...
    <div class="card green" id="card">
        ...
        <a class="loja" href="${link}" target="_blank"> Acesso a loja </a>
         ...
         <form action="/favitem" method="post" class="formulario"> 
         <input class="favbtn" type="submit" name="sign-in" value="Favoritos">
            <div class="user-box">
